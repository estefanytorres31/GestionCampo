...
export const updateUser = async (req, res) => {
    const { id } = req.params;
    const { nombre_usuario, nombre_completo, email, contrasena_hash } = req.body;

    try {
        const usuario = await UsuarioService.updateUser(id, nombre_usuario, nombre_completo, email, contrasena_hash);
